...
def compare_contexts():
    memsys_file = Path(
        "/Users/admin/Documents/Projects/b001-memsys_/evaluation/locomo_evaluation/results/locomo_evaluation_nemori/nemori_locomo_search_results_nemori.json"
    )
    nemori_file = Path(
        "/Users/admin/Documents/Projects/b001-memsys_/evaluation/locomo_evaluation/results/locomo_evaluation_nemori/nemori_locomo_search_results.json"
    )
    ...
    for user_id in all_user_ids:
        ...
        for query in sorted(list(all_queries)):
            ...
            if memsys_context is None:
                print(
                    f"Query found only in nemori_locomo_search_results.json: '{query}'"
                )
            ...
            if nemori_context is None:
                print(
                    f"Query found only in nemori_locomo_search_results_memsys.json: '{query}'"
                )
                differences_found = True
                continue
