...
class ExperimentConfig:
    ...
    reranker_instruction: str = (
        "Given a user's question and a text passage, determine if the passage contains specific information that directly answers the question. A relevant passage should provide a clear and precise answer, not just be on the same topic."
    )
