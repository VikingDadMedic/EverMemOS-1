...
class MemoryReranker:
    ...
    def __init__(
        ...
        self.default_instruction = (
            "Given a query, retrieve relevant information that answers the query"
        )
    ...
    def _process_inputs(
        self, pairs: List[Tuple[str, str]], instruction: str, max_length: int
    ) -> List[TokensPrompt]:
        """
        ...
        messages = [
            self._format_instruction(instruction, query, doc) for query, doc in pairs
        ]
    ...
    def rerank_memories(
        ...
        messages = self._process_inputs(
            pairs, instruction, max_length - len(self.suffix_tokens)
        )
    ...
    def rerank_memory_results(
        ...
        # Rerank memories
        reranked_memories = self.rerank_memories(
            query, memories, instruction, max_length
        )
