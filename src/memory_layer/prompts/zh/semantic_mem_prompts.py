...
[
  {
    "content": "未来几天user_2会经常关心user_1的恢复情况",
...
- **时间信息提取规则：**
  - start_time: 从MemCell的timestamp字段提取事件发生的具体日期，格式为YYYY-MM-DD
...
## 示例输入（生活场景）：
{
  ...
  "summary": "小明在今天下午成功拔除了智齿，医生强调未来一周注意饮食和清洁。",
  "episode": "2025年10月21日下午，小明讲述了拔牙经历，医生提醒要保持口腔清洁并定期复查。"
}

## 示例输出（生活场景）：
[
  {
    "content": "XiaoMing未来一周会调整饮食习惯",
    "start_time": "2025-10-21",
    "end_time": "2025-10-28",
    "duration_days": 7,
    "source_episode_id": "test-001"
